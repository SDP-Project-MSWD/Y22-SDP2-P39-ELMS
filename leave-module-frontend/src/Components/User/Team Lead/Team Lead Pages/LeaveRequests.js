...
function LeaveRequests() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Filter out employee IDs starting with 'E'
      const filteredInProgressLeaves = inProgressResponse.data.filter((leave) => leave.empID.startsWith('E'));
      const filteredAcceptedLeaves = acceptedResponse.data.filter((leave) => leave.empID.startsWith('E'));
      const filteredRejectedLeaves = rejectedResponse.data.filter((leave) => leave.empID.startsWith('E'));
