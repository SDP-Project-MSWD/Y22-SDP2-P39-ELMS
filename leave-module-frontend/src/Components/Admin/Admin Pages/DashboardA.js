...
const Dashboard = () => {
  ...
  useEffect(() => {
    try {
      API.get("http://localhost:4000/user/adminDashboard")
        .then((response) => {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="s">
        ...
        <Box sx={{ display: 'flex', gap: '30px', justifyContent: 'space-between', width: '100%', m: 3, paddingLeft: "20px", paddingRight: "20px" }}>
          <Card sx={{ width: 'calc(25% - 16px)' }}>
      ...
      <Box sx={{ display: 'flex', gap: '30px', justifyContent: 'space-between', width: '100%', paddingBottom: "20px" }}>
        <Card sx={{ width: 'calc(35% - 1px)', m:3 }}>
          <CardContent align="center">
            <Typography variant="body">
